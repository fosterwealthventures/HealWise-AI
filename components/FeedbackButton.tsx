  ...
  if (!isOpen) {
    return (
      <button
        ...
        className="fixed bottom-6 right-6 bg-brand-green-dark text-white p-4 rounded-full shadow-lg hover:bg-brand-green-dark/90 transition-transform transform hover:scale-110 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-brand-cream focus:ring-brand-green"
      ...
      <div className="bg-white rounded-2xl shadow-xl p-6 w-full max-w-md relative">
        {showSuccess ? (
          <div className="text-center py-10">
            ...
            <h3 className="text-xl font-bold text-brand-charcoal">Thank You!</h3>
            <p className="text-gray-500 mt-2">Your feedback has been submitted.</p>
          </div>
        ) : (
          <>
            <h2 className="text-2xl font-bold text-brand-charcoal">Share Your Feedback</h2>
            <p className="text-gray-500 mt-1 text-sm">We'd love to hear your thoughts on how we can improve.</p>
            <form onSubmit={handleSubmit} className="mt-6 space-y-4">
              <div>
                <label htmlFor="feedback-category" className="block text-sm font-medium text-gray-700">Category</label>
                <select
              ...
              <div>
                ...
                <textarea
                  ...
                  className="mt-1 block w-full p-2.5 border border-gray-300 rounded-md shadow-sm focus:ring-brand-green focus:border-brand-green sm:text-sm"
                  required
                />
              </div>
