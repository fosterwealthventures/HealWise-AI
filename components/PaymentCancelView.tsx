  ...
  return (
    <div className="animate-fade-in flex items-center justify-center h-full">
      <div className="text-center p-10 bg-white dark:bg-brand-charcoal-light rounded-2xl shadow-card max-w-lg">
        ...
        <h1 className="text-3xl font-bold text-brand-charcoal dark:text-brand-cream">Payment Canceled</h1>
        <p className="text-gray-500 dark:text-gray-400 mt-2 text-lg">
          Your transaction was not completed.
        </p>
        <p className="text-gray-500 dark:text-gray-400 mt-4">
          You have not been charged. You can return to the pricing page to try again or continue using the free features on your dashboard.
        </p>
